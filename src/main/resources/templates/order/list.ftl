            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                    <ul class="pagination pull-right">
                        ...
                        <#else>
                            <li>
                                <a href="/sell/seller/order/list?page=${currentPage -
                                1}&size=${size}">上一页</a>
                            </li>
                        </#if>
                        <#list 1..orderDTOPage.getTotalPages() as index>
                            ...
                            <#else>
                                <li>
                                    <a href="/sell/seller/order/list?page=${index}&size=${size}">${index
                                        }</a>
                                </li>
                            </#if>
                        </#list>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="location.reload()" type="button" class="btn
                            btn-primary">查看新的订单
                </button>
            </div>
        </div>
...
<script>
    ...
    if ('webSocket' in window) {
        webSocket = new WebSocket('ws://zhangbiao.natapp1.cc/sell/webSocket')
    } else {
